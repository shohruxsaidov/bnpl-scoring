  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { titleKey: 'routeTitle.merchant', breadcrumbKeys: ['breadcrumb.merchants', 'breadcrumb.detail'], feature: 'view_merchants' },
      },
      {
        path: 'deals',
        name: 'deals',
        component: () => import('@/views/DealsView.vue'),
        meta: { titleKey: 'routeTitle.deals', breadcrumbKeys: ['breadcrumb.deals'], feature: 'view_deals' },
      },
      {
        path: 'deals/:id',
        name: 'deal-detail',
        component: () => import('@/views/AdminDealDetailView.vue'),
        meta: { titleKey: 'routeTitle.deals', breadcrumbKeys: ['breadcrumb.deals', 'breadcrumb.detail'], feature: 'view_deals' },
      },
      {
        path: 'employees',
        name: 'employees',
        component: () => import('@/views/EmployeesView.vue'),
        meta: { titleKey: 'routeTitle.employees', breadcrumbKeys: ['breadcrumb.employees'], feature: 'manage_employees' },
      },
      {
        path: 'settings',
        name: 'settings',
        component: () => import('@/views/SettingsView.vue'),
        meta: { titleKey: 'routeTitle.settings', breadcrumbKeys: ['breadcrumb.settings'], feature: 'manage_settings' },
      },
      {
        path: 'tariffs',
        name: 'tariffs',
        component: () => import('@/views/TariffsView.vue'),
        meta: { titleKey: 'routeTitle.tariffs', breadcrumbKeys: ['breadcrumb.tariffs'], feature: 'view_tariffs' },
      },
      {
        path: 'blacklist',
        name: 'blacklist',
        component: () => import('@/views/BlacklistView.vue'),
        meta: { titleKey: 'routeTitle.blacklist', breadcrumbKeys: ['breadcrumb.blacklist'], feature: 'manage_blacklist' },
      },
      {
        path: 'buyout',
        name: 'buyout',
        component: () => import('@/views/BuyoutView.vue'),
        meta: { titleKey: 'routeTitle.buyout', breadcrumbKeys: ['breadcrumb.buyout'], feature: 'manage_buyout' },
      },
      {
        path: 'collection-board',
        name: 'collection-board',
        component: () => import('@/views/CollectionBoardView.vue'),
        meta: { titleKey: 'routeTitle.collectionBoard', breadcrumbKeys: ['breadcrumb.collectionBoard'], feature: 'view_collection_board' },
      },
      {
        path: 'scoring-history',
        name: 'scoring-history',
        component: () => import('@/views/ScoringHistoryView.vue'),
        meta: { titleKey: 'routeTitle.scoringHistory', breadcrumbKeys: ['breadcrumb.scoringHistory'], feature: 'view_scoring_history' },
      },
      {
        path: 'scoring-history/:id',
        name: 'scoring-detail',
        component: () => import('@/views/ScoringDetailView.vue'),
        meta: { titleKey: 'routeTitle.scoringHistory', breadcrumbKeys: ['breadcrumb.scoringHistory', 'breadcrumb.detail'], feature: 'view_scoring_history' },
      },
      {
        path: 'payments',
        name: 'payments',
        component: () => import('@/views/PaymentsView.vue'),
        meta: { titleKey: 'routeTitle.payments', breadcrumbKeys: ['breadcrumb.payments'], feature: 'view_payments' },
      },
      {
        path: 'notifications',
        name: 'notifications',
      ...
      },
      {
        ...
        meta: { titleKey: 'routeTitle.permissions', breadcrumbKeys: ['breadcrumb.permissions'], feature: 'manage_roles' },
      },
    ],
  },
