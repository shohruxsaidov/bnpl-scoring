...
export default async function scoringRoutes(app: FastifyInstance) {
  ...
  fastify.get(
    ...
    async (request, reply) => {
      try {
        return await getScoringSessionStatus(request.params.sessionId, userId(request));
      } catch (err: any) {
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        const result = await addScoringCard({
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        const result = await confirmScoringCard({
          sessionId: request.params.sessionId,
          userId: userId(request),
  ...
  fastify.post(
    ...
    async (request, reply) => {
      try {
        const result = await completeScoringCard({
          sessionId: request.params.sessionId,
          userId: userId(request),
