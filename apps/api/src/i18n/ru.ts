export const ru: Record<string, string> = {
  ...
  action_value_required: 'Для выбранного действия нужно указать цель',
  invalid_action_url: 'Ссылка должна начинаться с https://',
  invalid_banner_window: 'Дата окончания должна быть позже даты начала',
  faq_not_found: 'Вопрос не найден',
  faq_text_required: 'Вопрос и ответ должны быть заполнены на обоих языках',
  faq_reorder_mismatch: 'Список изменился. Обновите страницу и задайте порядок заново',
