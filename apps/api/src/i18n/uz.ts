export const uz: Record<string, string> = {
  ...
  faq_text_required: "Savol va javob ikkala tilda ham to'ldirilishi shart",
  faq_reorder_mismatch: "Ro'yxat o'zgargan. Sahifani yangilab, tartibni qaytadan belgilang",
